"""
Django settings for greProject project.
...
SECRET_KEY = 'django-insecure-0q-7eil*kh!23f7x#4v&7p@a2k=gmw2t!(7(=ht&zn%$x=*2u#'
...
WSGI_APPLICATION = 'greProject.wsgi.application'
